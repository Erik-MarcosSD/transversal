    ...
    return (
        ...
        >
            <div className="p-6 sm:p-10 md:p-16 flex flex-col items-center text-center">
                <p data-aos="fade-up" className="max-w-4xl text-xl sm:text-2xl leading-snug text-white">
                ...
                <div className="mt-10 w-full">
                    <h2 data-aos="flip-up" className="text-cyan-500 text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
                    ...
                    <ul className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 text-sm font-bold">
                        <li data-aos="fade-up" className="bg-gray-200 p-4 rounded-md w-72 flex items-center gap-3">
